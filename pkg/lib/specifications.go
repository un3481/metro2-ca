...
var (
	baseSegmentCharacterFormat = map[string]field{
		...
		"CorrectionIndicator":           {19, 1, alphanumeric | zeroFill, nullable},
		...
		"CurrencyTypeCode":              {213, 17, alphanumeric, nullable},
		"ConsumerTransactionType":       {230, 1, alphanumeric, nullable},
	...
	baseSegmentPackedFormat = map[string]field{
		...
		"CorrectionIndicator":           {13, 1, alphanumeric | zeroFill, nullable},
		...
		"CurrencyTypeCode":              {164, 17, alphanumeric, nullable},
		"ConsumerTransactionType":       {181, 1, alphanumeric, nullable},
	...
	j1SegmentFormat = map[string]field{
		...
		"ConsumerTransactionType":      {2, 1, alphanumeric, nullable},
